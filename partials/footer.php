    ...
    <div class="container pt-lg-4">
        <div class="row pb-5">
            <div class="col-lg-4 col-md-6">
                ...
                <p class="fs-sm text-light opacity-70 pb-lg-3 mb-4">Legis360 is an AI-driven platform revolutionizing legislative engagement across Africa. We bridge the gap between citizens and governance by making laws, policies, and decision-making processes more accessible, transparent, and participatory.</p>
            ...
            <div class="col-xl-6 col-lg-7 col-md-5 offset-xl-2 offset-md-1 pt-4 pt-md-1 pt-lg-0">
                <div id="footer-links" class="row">
                    ...
                    <div class="col-xl-4 col-lg-5 pt-2 pt-lg-0">
                        ...
                        <a href="mailto:info@legis360.org" class="fw-medium">info@legis360.org</a>
                    </div>
                </div>
            </div>
        </div>
        <p class="nav d-block fs-xs text-center text-md-start pb-2 pb-lg-0 mb-0">
            ...
            <a class="nav-link d-inline-block p-0" href="https://tenstepscreative.org" target="_blank" rel="noopener">Ten Steps Creative</a>
        </p>
    </div>
</footer>