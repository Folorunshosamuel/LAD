...
<body>
    <div class="container">
        <div class="row">
            ...
            $query = "SELECT id, name, position, constituency, state, image FROM legislators WHERE position IN ('Senate President', 'Deputy Senate President', 'Majority Leader', 'Deputy Majority Leader', 'Chief Whip', 'Deputy Whip', 'Minority Leader', 'Deputy Minority Leader', 'Minority Whip', 'Deputy Minority Whip') ORDER BY FIELD(position, 'Senate President', 'Deputy Senate President', 'Majority Leader', 'Deputy Majority Leader', 'Chief Whip', 'Deputy Whip', 'Minority Leader', 'Deputy Minority Leader', 'Minority Whip', 'Deputy Minority Whip');";
