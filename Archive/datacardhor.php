...
<body>
    <div class="container">
        <div class="row">
            ...
            $query = "SELECT id, name, position, constituency, state, image FROM legislators where chamber = 'House of reps' and position IN ('Speaker', 'Deputy Speaker', 'Majority Leader', 'Deputy Majority Leader', 'Majority Whip', 'Deputy Majority Whip', 'Minority Leader', 'Deputy Minority Leader', 'Minority Whip', 'Deputy Minority Whip') ORDER BY FIELD(position, 'Speaker', 'Deputy Speaker', 'Majority Leader', 'Deputy Majority Leader', 'Majority Whip', 'Deputy Majority Whip', 'Minority Leader', 'Deputy Minority Leader', 'Minority Whip', 'Deputy Minority Whip');";
