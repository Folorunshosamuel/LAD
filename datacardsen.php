...
<body>
    <div class="container">
        <div class="row">
            ...
            $query = "SELECT id, name, position, constituency, state, image FROM legislators WHERE position IN ('Senate President', 'Deputy Senate President', 'Chief Whip', 'Deputy Chief Whip') ORDER BY FIELD(position, 'Senate President', 'Deputy Senate President', 'Chief Whip', 'Deputy Chief Whip');";
